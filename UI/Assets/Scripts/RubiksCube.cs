...
public class RubiksCube
{
    ...
    //Controller
    public List<List<Color>> getFaceColors(Cube.sides numberFace)
    {
        switch (numberFace)
        {
            ...
            case Cube.sides.LEFT:
                return getLeftFaceColors();
            case Cube.sides.BACK:
                return getBackFaceColors();
            case Cube.sides.TOP:
    ...
    public List<List<Color>> getBottomFaceColors()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                row.Add(cubeMatrix[i][0][j].getColor(Cube.sides.BOTTOM));
            }
            face.Add(row);
        }
        return face;
    ...
    public void printFaceColors(List<List<Color>> faceColors, string faceName)
    {
        Debug.Log("printing " + faceName);
        for(int i = 0; i < faceColors.Count;i++)
        {
            for (int j = 0; j < faceColors[i].Count; j++)
            {
    ...
    {
        List<List<List<Color>>> faceList = new List<List<List<Color>>>();
        faceList.Add(getFaceColors(Cube.sides.BACK));
        faceList.Add(getFaceColors(Cube.sides.FRONT));
        faceList.Add(getFaceColors(Cube.sides.BOTTOM));
        faceList.Add(getFaceColors(Cube.sides.TOP));
        faceList.Add(getFaceColors(Cube.sides.LEFT));
        faceList.Add(getFaceColors(Cube.sides.RIGHT));
        return faceList;
    }

    public void printAllFaces()
    {
        printFaceColors(getFaceColors(Cube.sides.BACK), "BACK");
        printFaceColors(getFaceColors(Cube.sides.FRONT), "FRONT");
        printFaceColors(getFaceColors(Cube.sides.BOTTOM), "BOTTOM");
        printFaceColors(getFaceColors(Cube.sides.TOP), "TOP");
        printFaceColors(getFaceColors(Cube.sides.LEFT), "LEFT");
        printFaceColors(getFaceColors(Cube.sides.RIGHT), "RIGHT");
    }

    public List<List<Color>> getLeftFaceColors()
    {
        List<List<Color>> face = new List<List<Color>>();
        for (int i = 0; i < 3; i++)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                row.Add(cubeMatrix[0][i][j].getColor(Cube.sides.LEFT));
            }
            face.Add(row);
        }
        return face;
    ...
    public List<List<Color>> getRightFaceColors()
    {
        List<List<Color>> face = new List<List<Color>>();
        for (int i = 0; i < 3; i++)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                row.Add(cubeMatrix[2][i][j].getColor(Cube.sides.RIGHT));
            }
            face.Add(row);
        }
        return face;
    ...
    public List<List<Color>> getFrontFaceColors()
    {
        List<List<Color>> face = new List<List<Color>>();
        for (int i = 0; i < 3; i++)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                row.Add(cubeMatrix[i][j][0].getColor(Cube.sides.FRONT));
            }
            face.Add(row);
        }
        return face;
    ...
    public List<List<Color>> getBackFaceColors()
    {
        List<List<Color>> face = new List<List<Color>>();
        for (int i = 0; i < 3; i++)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                row.Add(cubeMatrix[i][j][2].getColor(Cube.sides.BACK));
            }
            face.Add(row);
        }
        return face;
    ...
    public List<List<Color>> getTopFaceColors()
    {
        List<List<Color>> face = new List<List<Color>>();
        for (int i = 0; i < 3; i++)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                row.Add(cubeMatrix[i][2][j].getColor(Cube.sides.TOP));
            }
            face.Add(row);
        }
        return face;
